...
|---|---|---|
| FS-01 | `DRAFT_NOT_AUTHORIZED` | `NOT STARTED` |
| FS-02 | `PLANNED_NOT_AUTHORIZED` | `NOT STARTED` |
| FS-03 | `PLANNED_NOT_AUTHORIZED` | `NOT STARTED` |
| FS-04 | `PLANNED_NOT_AUTHORIZED` | `NOT STARTED` |
| FS-05 | `PLANNED_NOT_AUTHORIZED` | `NOT STARTED` |
| FS-06 | `PLANNED_NOT_AUTHORIZED` | `NOT STARTED` |
| FS-07 | `PLANNED_NOT_AUTHORIZED` | `NOT STARTED` |
| FS-08 | `PLANNED_NOT_AUTHORIZED` | `NOT STARTED` |
| FS-09 | `PLANNED_NOT_AUTHORIZED` | `NOT STARTED` |
| FS-10 | `PLANNED_NOT_AUTHORIZED` | `NOT STARTED` |
| FS-11 | `PLANNED_NOT_AUTHORIZED` | `NOT STARTED` |
| FS-12 | `PLANNED_NOT_AUTHORIZED` | `NOT STARTED` |
